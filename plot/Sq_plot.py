...
def plot_Sq(tex_lw=240.71031, ppi=72):
    ...
    ax01.legend(title=r"$f_f$", ncol=1, columnspacing=0.5, handlelength=0.5, handletextpad=0.2, frameon=False, fontsize=9)
    ...
    ax11.legend(title=r"$f_sL$", ncol=1, columnspacing=0.5, handlelength=0.5, handletextpad=0.2, frameon=False, fontsize=9)
